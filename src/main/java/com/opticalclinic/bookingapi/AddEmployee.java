...
public class AddEmployee extends OpticalClinicBookingSystem{
   
    
    public void showRegisterPanel(Employee employee) {
        ...
        um.handleRegistration(frame, usernameField, passwordField, confirmPasswordField, 
                                           nameField, phoneField, yearComboBox, monthComboBox, 
                                           dayComboBox, employee);
         });
